...
import net.fabricmc.example.blocks.CheeseCauldronBehavior;
...
public class ExampleMod implements ModInitializer {
	...
	public void onInitialize() {
		CheeseCauldronBehavior.init();
		CHEESE_ITEM = Registry.register(Registry.ITEM, new Identifier(MOD_ID, "cheese"), new Item(new FabricItemSettings().group(ItemGroup.FOOD).maxCount(64))); // TODO: Add proper cheese item class and functionality
